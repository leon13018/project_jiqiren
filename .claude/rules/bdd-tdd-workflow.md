...
> **不重啟：** 純 docstring / bug fix 改一行 / 既有 prod code 純 refactor — 仍跑既有 245 tests 當回歸網（2026-05-26 Wave 0-10 = 233 → 2026-05-27 Wave 4 hotfix 1-3 + dialog 客服 re-speak fix = 248 → S2/S4 session 中 L5 mute 移除 + stdin UnicodeDecodeError test 移除 = 245）。

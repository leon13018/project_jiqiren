...
本 package 採子模組拆分：
    - l0_subroutine_a.py    — L0 共通子例程 A（「回 L1 叫賣」）
...
from myProgram.sales.states.l0_subroutine_a import run_subroutine_a
from myProgram.sales.states.l1 import run_l1
from myProgram.sales.states.l2_l3_dialog import run_dialog

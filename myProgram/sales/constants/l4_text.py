...
L4_D_FINAL_PROMPT: str = "因為都沒有付款，系統即將取消這次交易，請選擇『取消訂單』或『繼續當前付款』（語音說或終端輸入 1=取消 / 2=繼續 皆可）"
...
# L4 終端模擬掃碼提示（2026-05-26 Wave 7a C21：抽常數，未來接真 QR code 時只改此一處）
# 顯示於訂單明細末行；S2+ 接真 QR code 時改為「請掃碼付款」即可

...
KEYWORDS_CONFIRM_YES_STRICT_SHORT: list = ["好", "是", "對", "嗯", "ok", "y"]
...
# 冰紅茶關鍵字（全繁體 + 英文；STT 繁體輸出，簡體 keyword 已於 2026-06-13 全繁體化移除）
...
# strict_short 省略：原兩集（繼續/取消、退出/離開）全為對應 substring 集子集，

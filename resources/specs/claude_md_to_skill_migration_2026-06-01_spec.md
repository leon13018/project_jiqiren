...
.claude/skills/project-01-workflow/       ← description 常駐，body 用到才載
  ...
  reference/                             ← 12 個 workflow / 領域細節，Read on demand
...
1. SKILL.md router 的**觸發語句寫明確**（「編 `myProgram/` code 前，先 Read `reference/myprogram-*.md`」），降低漏載。
...
| 🌏 輸出語言 | 「所有產出物中文一律繁體（成果在台灣展示）」一句 + 指向 `reference/conventions.md` 看簡繁對照 | 現 🌏 段精簡 |
...
**刪除**：8 大流程段（內容進 skill）、🌐 部署表（進 `reference/pi-and-structure.md`）、40 行查閱表、維護原則段。
...
| 當我要… | Read |
|---|---|
| 改 `myProgram/` code（走 SDD） | `reference/sdd.md` + `examples/` reviewer 範本 |
| 編 myProgram 前理解廠商 SDK / 動作 API | `reference/myprogram-vendor.md` |
| 編 myProgram 多線程 / 路徑 | `reference/myprogram-threading-paths.md` |
| 改 sales 對話狀態機 / 跨層流程設計 | `reference/sales-dialog-design.md` |
| 改 sales TTS / 計時 / UX 過場設計 | `reference/sales-tts-ux.md` |
| 派 subagent / 判斷派發規模 | `reference/dispatch.md` |
| 進 worktree / 收尾 merge | `reference/worktree.md` |
| git 收尾 5 步 / sync Pi | `reference/standard-workflow.md` |
| 判斷 Pi 端操作 / 寫 pineedtodo / 更新 projectStructure | `reference/pi-and-structure.md` |
| 架構多線程難收斂 | `reference/incremental-rebuild.md` |
| 新增 sales 業務邏輯（BDD+TDD，dormant） | `reference/bdd-tdd.md` |
| 繁簡對照 / 環境 quirk / 跨任務工作原則 | `reference/conventions.md` |

### 4.3 reference/（12 個檔，內容映射見 §6）
...
| Rule 檔 | 去向 |
|---|---|
| `sdd-workflow.md` | reference/sdd.md |
| `worktree-workflow.md` | reference/worktree.md |
| `subagent-dispatch-protocol.md` | reference/dispatch.md |
| `standard-workflow.md` | reference/standard-workflow.md |
| `pi-side-trigger.md` | reference/pi-and-structure.md |
| `projectstructure-trigger.md` | reference/pi-and-structure.md |
| `incremental-rebuild.md` | reference/incremental-rebuild.md |
| `bdd-tdd-workflow.md` | reference/bdd-tdd.md |
| `vendor-sdk-api.md` | reference/myprogram-vendor.md |
| `threading-conventions.md` | reference/myprogram-threading-paths.md |
| `path-conventions.md` | reference/myprogram-threading-paths.md |
...
| `sdd_workflow.md` | reference/sdd.md |
| `worktree_workflow.md` | reference/worktree.md |
| `gotcha_m_post_commit_workflow.md` | reference/worktree.md |
| `subagent_dispatch.md` | reference/dispatch.md |
| `dispatch_threshold_by_change_size.md` | reference/dispatch.md |
| `worker_level_changes_dispatch_sales_coder.md` | reference/dispatch.md |
| `sales_coder_subagent.md` | reference/dispatch.md |
| `wave_workflow_6_protections.md` | reference/dispatch.md |
| `standard_workflow.md` | reference/standard-workflow.md |
| `background_session_hook_skip.md` | reference/standard-workflow.md |
| `python_pycache_stale_on_pull.md` | reference/standard-workflow.md + scripts/clean-pi-pycache.ps1 |
| `workflow_constraints.md` | reference/standard-workflow.md |
| `pineedtodo_spec.md` | reference/pi-and-structure.md |
| `project_deployment.md` | reference/pi-and-structure.md |
| `pi_glibc_piwheels_trap.md` | reference/pi-and-structure.md |
| `git_sync_verify_before_debug.md` | reference/pi-and-structure.md |
| `incremental_rebuild_pattern.md` | reference/incremental-rebuild.md |
| `single_queue_preference.md` | reference/incremental-rebuild.md |
| `vendor_stop_action_sticky.md` | reference/incremental-rebuild.md（+ myprogram-vendor cross-ref） |
| `bdd_tdd_workflow.md` | reference/bdd-tdd.md |
| `vendor_files.md` | reference/myprogram-vendor.md |
| `vendor_runaction_silent_fail.md` | reference/myprogram-vendor.md |
| `s6_non_blocking_input.md` | reference/myprogram-threading-paths.md（S6 worker 架構） |
| `c2_three_way_design.md` | reference/sales-dialog-design.md |
| `l4_ack_wallclock_budget_design.md` | reference/sales-dialog-design.md |
| `cancel_confirm_cross_l.md` | reference/sales-dialog-design.md |
| `service_confirm_unified.md` | reference/sales-dialog-design.md |
| `confirm_default_must_be_conservative.md` | reference/sales-dialog-design.md |
| `speak_and_wait_architecture.md` | reference/sales-tts-ux.md |
| `countdown_print_design.md` | reference/sales-tts-ux.md |
| `tts_prompt_as_ux_pacing.md` | reference/sales-tts-ux.md |
| `ux_over_technical_correctness.md` | reference/sales-tts-ux.md |
| `goal_condition_design.md` | reference/conventions.md |
| `fix_one_path_sweep_related.md` | reference/conventions.md |
| `output_language.md` | CLAUDE.md 核心保留規則 + 簡繁對照細節 → reference/conventions.md |
| `user_environment.md` | reference/conventions.md（cp936 / 簡繁環境 quirk） |

...
> 最後更新：2026-05-30（新增 `tests/sales/test_tts_worker.py` — `TtsWorker` Condition + `_pending` counter unit tests + R1 race regression；對應 commit `c418004` `speak_and_wait` callback v2；HEAD `c418004`，302 tests）

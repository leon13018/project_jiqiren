...
> 最後更新：2026-05-31（SDD 流程正式化 — 新 `.claude/rules/sdd-workflow.md` + 新 `resources/specs/` folder + git mv L4_v3 spec + CLAUDE.md / sales-coder.md 更新；HEAD `c586173`，386 tests）
...
│   │   └── sdd-workflow.md               # 📐 SDD 流程完整版（2026-05-31 加）— spec template 兩種 / 4 階段 / 雙軌 TaskCreate / sales-coder prompt 範本（無 paths，啟動載入）
...
└── resources/                            # 開發 / 部署參考資源（2026-05-22 重構：大部分 tracked）
    ...
    │   ├── sdd_workflow_formalization_2026-05-31_spec.md  # SDD 流程正式化 meta-spec（第一個跑新規範的 spec doc）

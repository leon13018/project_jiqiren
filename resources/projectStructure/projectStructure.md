...
> 最後更新：2026-05-31（新增 `resources/research/` 資料夾 + `SDD_best_practices_2026-05-31.md` — 3 個 opus xhigh subagent 並行調研 SDD 最佳實踐多源整合報告；HEAD 待 commit，386 tests）
...
└── resources/                            # 開發 / 部署參考資源（2026-05-22 重構：大部分 tracked）
    ...
    │   │   ├── L4_v3_dual_timer_spec.md  # L4 v3 SDD 規格書（2026-05-31 加）：雙獨立計時器設計（36s budget + 12s QR refresh cycle），子鏈路 ack 不影響任何計時器；supersedes L4.md 計時器段
